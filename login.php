<?php
// login.php — ZerPes authentication gate
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username) || empty($password)) {
        $error = '❌ Username and password required, baddie.';
    } else {
        try {
            ...
            if ($user && password_verify($password, $user['password_hash'])) {
                ...
                $error = '❌ Wrong username or password, cunt.';
            }
    ...
    <style>
        * {
        ...
        .login-box button:hover {
            ...
            box-shadow: 0 8px 30px #a855f766;
        }
        .error {
            color: #fca5a5;
...
<body>
    <div class="login-box">
        ...
        <div class="hint">
            Default: <strong>admin</strong> / <strong>Admin2026!</strong>
        </div>
        <div class="brand-foot">ZerPes · v1.0 · PostgreSQL</div>
    </div>
</body>
</html>